...
/* USER CODE BEGIN PV */
adxl345_t config = { .Range = range_setting_16g, .Data_Rate = data_rate_100HZ,
		.Power_Mode = saving_power_mode, .AG_HW_Interface_t.Read_Hw_Data =
				Read_Hw_Data, .AG_HW_Interface_t.Write_HW_config =
				Write_HW_config
